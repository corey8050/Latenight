...
public class OrderContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.shakeapp";
    ...
    public static abstract class OrderEntry implements BaseColumns{
        ...
        public static final String COLUMN_ISSMALL = "isSmalls";
        public static final String COLUMN_LARGE = "hasLarge";
    }
}
